...
// @route POST /api/cart
// @desc Add a product to the cart far a guest or logged in user
// @access Public
    ...
    try {
        ...
        if (productIndex > -1) {
            ...
            if (quantity > 0) {
                ...
                cart.products.splice(productIndex, 1);//Remove the product if quantity is less then or equal to Zero
            }
